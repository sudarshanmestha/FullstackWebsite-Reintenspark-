...
import Navbar from './components/nav' // FIXED: Removed curly braces
...
export const metadata: Metadata = {
  ...
  title: {
    "default": 'ReintenSpark Technology Pvt Ltd.', // Added quotes around default
    template: '| Innovation in Drones & AI',
  },
  ...
  openGraph: {
    ...
    url: baseUrl,
    siteName: 'reintenspark.com', // Updated to match your site 
    locale: 'en_US',
    type: 'website',
  },
  robots: {
